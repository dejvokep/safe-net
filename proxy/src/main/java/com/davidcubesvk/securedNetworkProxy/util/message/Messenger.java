package com.davidcubesvk.securedNetworkProxy.util.message;
...
/**
 * Class used to send messages to a player.<br>
...
public class Messenger {
     ...
     */
    private String getLastColor(String searched, String next) {
